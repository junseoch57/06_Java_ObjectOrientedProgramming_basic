 ...
 *   # 클래스(class)
 *   
 *     - 클래스(class)는 객체 지향 프로그래밍(OOP)에서 특정 객체를 생성하기 위해 변수와 메소드(중요!)를 정의하는 일종의 템플릿 또는 설계도이다. 
 *     
 *     - 객체의 속성과 행동을 정의한다.
 *     
 *      [ 형태 ]
...
class Member {  // 클래스의 이름은 대문자로 시작한다.
	...
	// 필드(field) , 속성(properties) , 멤버변수, 멤버
	// 먼저 틀을 만들어 놓음
	String id;
	String password;
	String name;
...
public class ClassEx01 {
	...
	public static void main(String[] args) {
		...
		// new 클래스명(); 형태로 객체(object,instance)를 생성한다.
		Member member1 = new Member();   //실제는 new Member();  //member1(링크) 링크를 통해 데이터에 접근함
		member1.id = "qwer1234";
		member1.password = "1111";
		member1.name = "익명1";
		member1.hp = "010-1234-5678";
		member1.email = "qwer123@naver.com";
		member1.address = "서울";
		...
		member2.name = "익명2";
		member2.hp = "010-3333-5555";
		member2.email = "abcd12345@gmail.com";
		member2.address = "경기";
